...
public class JDlgDrfCompraPesquisa extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgDrfCompraPesquisa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgDrfCompraPesquisa dialog = new JDlgDrfCompraPesquisa(new javax.swing.JFrame(), true);
