...
if (jTxtNome.getText().equals("") && jTxtcpf.getText().equals("")){
    List list = usuarios_DAO.listNomeCpf(jTxtNome.getText(), jTxtcpf.getText());
    usuariosControle.setList(list);
}}
if (jTxtcpf.getText().equals("")&& jTxtNome.getText().equals("") ){
    List lista = usuarios_DAO.listCpf(jTxtcpf.getText());
    usuariosControle.setList(lista);
}
