 ...
 * @author rafae
 */
public class JDlgDrfUsuariosPesquisa extends javax.swing.JDialog {
 private JDlgDrfUsuarios jDlgUsuarios;
 DrfUsuariosDAO usuarios_DAO;
    UsuariosControle usuariosControle;
    /**
     * Creates new form JDlgUsuariosPesquisa
     */
    public JDlgDrfUsuariosPesquisa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 ...
 public void setTelaAnterior(JDlgDrfUsuarios jDlgUsuarios) {
...
int  rowSel = jTable1.getSelectedRow();
        DrfUsuarios usuarios = usuariosControle.getBean(rowSel);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgDrfUsuariosPesquisa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgDrfUsuariosPesquisa dialog = new JDlgDrfUsuariosPesquisa(new javax.swing.JFrame(), true);
