 ...
 if (Util.perguntar("Deseja excluir o usuario?") == true){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgDrfProdutoNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgDrfProdutoNovo dialog = new JDlgDrfProdutoNovo(new javax.swing.JFrame(), true);
